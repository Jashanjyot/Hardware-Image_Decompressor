...
add wave -dec UUT/M2_unit/row
add wave -dec UUT/M2_unit/col
add wave -dec UUT/M2_unit/curr_max_row
add wave -hex UUT/M1_unit/R_val
add wave -hex UUT/M1_unit/G_val
add wave -hex UUT/M1_unit/B_val